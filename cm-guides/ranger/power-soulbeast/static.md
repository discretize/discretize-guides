...
5. <Skill name="One Wolf Pack"/>
6. Take _Mistlock Singularity_
7. <Skill name="One Wolf Pack"/>
8. <Skill name="Call of the Wild"/> (Warhorn 5)
...
13. <Skill name="Slash"/> (Sword 1 chain)
14. <Skill name="Pounce"/> (Sword 2)
15. <Skill name="Serpents Strike"/> (Sword 3)
16. <Skill name="Slash"/> (Sword 1 chain)
...
- In a fast kill one <Specialization name="Soulbeast"/> has to "control" the CC phase by delaying their <Skill name="Point Blank Shot"/>. This is done to ensure cooldowns will be ready in the next phase. Usually the CC should be completed as or right after the marble hits.
...
- Pulling the adds is also great since they can hurt your <Trait name="Loud Whistle"/> uptime.
...
Open with high priority Hammer skills, then swap weapons.
Use <Skill name="Path of Scars"/> and <Skill name="Whirling Defense"/> while facing away from the eye.
At the end of the phase leave <Skill name="Beastmode"/> to not unmerge in case the bomb goes off.
</InformationBlock>
<InformationBlock title="Tips">

- Precasting <Skill name="Spike Trap"/> and <Skill name="Barrage"/> ensures instant <Item name="Relic of Fireworks"/> and <Trait name="Twice as Vicious"/>. This allows skipping <Skill name="Overbearing Smash"/> and <Skill name="Worldly Impact"/>.
...
<Skill name="Sic Em"/> as soon as possible.
Use Hammer skills, swap to axe and position yourself where the last pizza slice will appear.
Use <Skill name="Path of Scars"/> and <Skill name="Whirling Defense"/> to refresh <Trait name="Twice as Vicious"/> and <Item name="Relic of Fireworks"/>.
Step out of the pizza slice as <Skill name="Whirling Defense"/> ends.
</InformationBlock>
</CMInformation>
<IdealRotation>
...
Use <Skill name="Unleashed Thump"/> and during it press _Hypernova Launch_.
</InformationBlock>
</CMInformation>
<IdealRotation>
...
1. <Skill name="Unleashed Wild Swing"/> (Hammer 2)
1. <Skill name="Unleashed Savage Shock Wave"/> (Hammer 4)
1. _Weapon Swap_
1. <Skill name="Path of Scars"/> (Axe 4)
1. Short <Skill name="Whirling Defense"/> (Axe 5)
1. <Skill name="Splitblade"/> (Axe 2)
1. <Skill name="Winters Bite"/> (Axe 3)
