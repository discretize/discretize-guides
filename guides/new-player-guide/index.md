...
### Profession-specific
These refer to _specific_ builds a group is asking for.
...
| `HFB`               | Heal Firebrand          | `healbrand`, `quickheal`                   | <Specialization name="Firebrand" text="Heal Firebrand"/> for <Boon name="Quickness"/> and group support, Healer build                   | <BuildLink build="Heal Firebrand" specialization="Firebrand"/>                                                                         |
| `HAM`        | Heal Alacrity Mechanist | `alacheal`, `heal mech`                 | <Specialization name="Mechanist"/> for <Boon name="Alacrity"/> and healing                                                              | <BuildLink build="Heal Mechanist" specialization="Mechanist"/>                                                                         |
