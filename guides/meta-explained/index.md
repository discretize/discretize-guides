...
| <BuildLink build="Seraph Firebrand" specialization="Firebrand"/>                                                                                                                                                                                                                     | <br/>The <Specialization text="Firebrand" name="Firebrand"/> role consists of providing 100% <Boon name="Quickness"/> uptime, utilities in terms of crowd control, reflects, shared <Boon name="Aegis"/> and medium DPS. It can even provide <Boon name="Resistance"/> for a short time with tomes. <br/><br/><Card><Specialization text="Seraph Firebrand" name="Firebrand"/> is currently best in PuGs, making fractals effortless by provinding all the important boons a Heal Firebrand can, whilst dealing some damage. However <BuildLink build="Heal Firebrand" specialization="Firebrand"/> can be taken for more of a safety net. In more confident groups playing <BuildLink build="Condi Firebrand" specialization="Firebrand"/> is also an option,</Card><br/> |
