...
Note that the <Specialization eliteSpecialization="Druid"/>'s <Skill id="31869"/> and <Skill name="Reapers Shroud"/> for <Specialization eliteSpecialization="Reaper"/> will fully recharge after the resurrection.
</GridItem>
<GridItem sm="4">
...
| <Instability name="No Pain, No Gain"/>    | Enemies receive <Boon name="Protection"/>, <Boon name="Might"/> and <Boon name="Fury"/> when you hit them. Has a 20 second internal cooldown per enemy, <Specialization eliteSpecialization="Renegade"/> can strip with <Skill name="Banish Enchantment"/> (<Skill name="Legendary Demon stance"/>) or <Specialization eliteSpecialization="Reaper" text="Power Reaper"/> can strip with <Skill name="Well of Corruption"/> and weapon skills or <Skill name="Throw mine"/> from <Specialization eliteSpecialization="Holosmith"/> or <Specialization name="Chronomancer"/> can strip with <Skill name="Phantasmal Disenchanter"/> or auto-attacks. Stripping an enemy boon will steal their life.   |
...
| <Instability name="Toxic Trail"/>         | Enemies leave a trail of poison behind them which inflicts direct damage and the <Condition name="poison"/> condition. Blocking a toxic-trail attack will absorb it and cleanse the condition. It can be very dangerous when fighting multiple mobs. Removes <Boon name="Aegis"/>.  |
...
| <Instability name="We Bleed Fire"/> | Enemies create flaming missiles when damaged. Incoming condition damage is reduced by 20%. It can be reflected for extra damage. In T4s <Specialization eliteSpecialization="Renegade"/> should bring <Skill name="Legendary Centaur stance"/> and keep the bubble up in critical moments.    |
