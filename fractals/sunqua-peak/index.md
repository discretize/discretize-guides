...
<Grid>
<GridItem sm="8">
The second boss of the fractal is a big pile of rocks. Whoever is closest to the dark cloud on the side of the arena gets tethered to it and receives the debuff <Uncategorized name="tidalbargain"/> that increases over time. Before reaching 10 stacks another player should take the tether by running inside the beam between the cloud and the tethered player and stay there for one second.
</GridItem>
...
<Grid>
<GridItem xs="12" sm="7">
After crossing the green line the fight starts. After about one second Ai dashes to a randomly chosen side and a CC bar appears which should be broken as soon as possible to get the <Effect name="Exposed"/> buff. Ideally the group phases her in the corner, else she will repeat the attack pattern one more time. 
...
She will keep dashing around the arena and mixing and matching her abilities described above until she dashes to the middle of the arena. The only difference being in the middle of the arena does is that during the split phase instead of pulsing AoE's lasers appear that will converge once the expanding AoE's on the players explode. Be careful when walking back into the boss as these lasers will converge on her in two waves and deal heavy damage. You can tell the ticking AoE apart from the converging AoE by weather or not there is an arrow attatched to them. If an arrow is present it will converge, if not it will tick.
