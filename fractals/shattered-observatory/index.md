...
<Tips>
    ...
    <Tip specialization="weaver">Start in <Skill id="5495" text="false"/>/<Skill id="5492" text="false"/> with <Skill id="5528"/> and <Skill id="43638"/> if your group does not plan to nuke the second phase with a portal. Make sure that you have all charges of <Skill id="5539"/> when you reopen on the boss. If you plan to nuke either phase 2 or phase 3 with a portal, pre cast <Skill id="43638"/> before taking the portal, take the portal before the last add is dead and open with precasting <Skill id="5737"/> followed by <Skill id="5501"/>.</Tip>
...
<Tips>
    ...
    <Tip specialization="weaver"> Start in <Skill id="5492" text="false"/>/<Skill id="5495" text="false"/> with <Skill id="5548"/> and <Skill id="43762"/>. Attune to <Skill id="5494" text="false"/>/<Skill id="5492" text="false"/> and cast <Skill id="5737"/> while turned away to avoid the *Blinding Radiance* <Condition name="fear"/>. Continue with <Skill id="5501"/>.    
        **Always** place a <Skill id="5548"/> on the Temporal Anomaly and use <Skill id="5539"/> as backup. If you aim your  <Skill id="41125"/> correctly, it can hit the boss and the anomaly. (In a tripple weaver composition three hits of  <Skill id="41125"/> will kill the anomaly. Also place you <Skill id="5548"/> in the first three seconds of the anomaly, if it has cooldown in that time use either <Skill id="43762"/> or <Skill id="5528"/>, if you have none of those skills ready use <Skill id="5491"/>. But make sure to instantly damage the anomaly in some way and not wait 5-6 seconds until your <Skill id="5548"/> is off cooldown.)   
        If your damage is good enough, you can skip the second and fourth anomaly by nuking the boss to 70% and 40%. With good damage you can also skip the fifth anomaly by nuking the boss from 30% to zero.    
        Never cast <Skill id="5737"/> or <Skill id="5501"/> during the intermediate phases, instead wait and reopen with them on Arkk.</Tip>
