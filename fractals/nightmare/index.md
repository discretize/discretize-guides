...
<Tips>
    ...
    <Tip specialization="elementalist">Use <Skill id="5733"/> from your Lightning Hammer for CC.<br/>You can share <Skill id="5516"/> with the other <Specialization name="elementalist"/> as you can only use one per phase anyway.</Tip>
