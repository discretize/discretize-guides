...
Pay attention! In average groups 5 Volatile Hallucinations will spawn in various locations around the arena. Each of them will target the closest player and apply a teather-like effect on them effectively making visible to who they are targeted on. Approaching the add will cause it explode the moment it reaches melee range which will cause daze and apply conditions to all players in it's explosion radius. The add whoever will not explode if its killed while its target is outside of the explosion radius. A good practice is to move to the opposite side of the boss and let the add walk through the hitbox. This will cause the add to die by cleave before it reaches its target, neutralizing the threat.  
