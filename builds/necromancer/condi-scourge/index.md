...
<Warning>
Always playing with <Skill name="Summon Shadow Fiend"/> by default will be suboptimal in fractals. Make use of the whole toolkit depending on the fractal and instabilities!
</Warning>

|                                                               |                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------                                                                                                                                                                                                                             |
| <Skill name="Summon Shadow Fiend" size="big" disableText/>         | The go to option for long fights, providing you with Life Force whenever the active effect <Skill name="Haunt"/> gets used.|
| <Skill name="Signet of Spite" size="big" disableText/>         | Your highest dps option on your third utility slot, if Life Force is covered e.g. the dark Phase of[Sunqa Peak](/fractals/uncategorized) Challenge Mode.                                                          |
...
| <Skill name="Epidemic" size="big" disableText/>               | Only use this skill in organised groups at the dark Phase of the[Sunqa Peak](/fractals/uncategorized) Challenge Mode. Copying all slow CC conditions like <Condition name="Immobile" /> and <Condition name="Slow" /> onto the Sorrows, which requires certain classes like a Specter to become an alternative of Spectral Grasp .
