...
- Below 50% boss HP: <Skill name="Gravedigger" /> (Greatsword 2) replaces  <Skill name="Dark Pact" /> (Dagger 3), <Skill name="Death Spiral" /> (Greatsword 3) and Greatsword Auto-Attacks.
 
Cancel the aftercasts with any other skill or Weapon Swap (Shroud works as well) or simply by pressing Auto-Attack in between two casts. 
Also skip one Auto-Attack chain at the end of your Greatsword shroud loop.
