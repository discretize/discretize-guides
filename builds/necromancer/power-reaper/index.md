...
On fights where you do not benefit from <Item id="24868"/>, or specific slaying sigils such as <Item id="24658"/> and <Item id="24664"/>, or from <Item id="36053"/>, you can drop <Item id="24868"/> for <Item id="24618"/> to gain a minor damage increase. However, then you need to use the [Gear Optimizer](https://optimizer.discretize.eu/?m=fractals) to adjust your build for the missing crit chance. If you happen to have a build with <Item id="24618"/> from raiding, you can of course use that to start out playing fractals, but it is strongly advised to swap to an <Item id="24868"/> build as soon as possible as that provides a noticable dps gain on almost all fights. Slotting in specific slaying and night sigils then further increase your damage. As far as consumables are concerned, <Item id="43360"/>, <Item id="50082"/> and <Item id="8886"/> are commonly used to further boost your damage over the standard build when they work. Use the [cheat sheet](https://www.discretize.eu/guides/cheat-sheet/) to find the optimal combination of sigils and potions for a specific fractal. 
