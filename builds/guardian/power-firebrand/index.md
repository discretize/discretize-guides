...
sections:
  - type: mdx
    title: Overview
    content: >-
      The **<Specialization text="Power Quickness Firebrand"
      name="Firebrand"/>** (also **_Quickness Firebrand_** or **_Quickbrand_**)
      provides permanent <Boon name="Quickness"/> to the party while dealing
      very decent DPS.
...
character:
  - title: 162 Agony Resistance (24.6% BD)
    note: >-
      Note that this build variant only gains boon duration from the <Item
      id="79722"/>.
    ...
    gear: |-
      {
        ...
        "attributes": {
          ...
          "Boon Duration": 25.066666666666666,
          "Critical Chance": 100,
          "Critical Damage": 251.33333333333331,
          "Effective Power": 25159.670929721146,
          "Power DPS": 32842.23506035991,
    ...
    gear: |-
      {
        ...
        "attributes": {
          ...
          "Condition Duration": 0,
          "Boon Duration": 24.866666666666667,
          "Critical Chance": 100.80952380952381,
          "Critical Damage": 252.93333333333334,
