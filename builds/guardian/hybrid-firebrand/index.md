...
- If the encounter allows you to, you can prestack the following symbols:
  ...
  - This way, when the enounter starts, 3 symbols will hit the target
- On Greatsword:
...
- <Skill name="Tome of Justice"/> (F1):
  - Skill 4 is a ticking AoE, good for single target and great for AoE DPS, provides firefield so make sure to use it before the fight to stack some might
