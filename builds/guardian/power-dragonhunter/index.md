...
---
<Warning>  
This page has an beginner and an advanced tab. The advanced tab showcases the more recent spear build. The beginner tab features the oldschool longbow build. The advanced tab also shows the gear for both radiance and virtues setups. A somewhat recent pug guide video can be found [here](https://www.youtube.com/watch?v=VBhJXMZtlqA).
</Warning>
