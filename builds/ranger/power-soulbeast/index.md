...
- **You should never swap out <Skill name="Frost Trap"/> or <Skill name="OneWolfPack"/> as they are both massive damage buffs both personally and for the team!**
...
- Your final utility varies depending on the situation. Generally, you want to run either <Skill name="Signet of the Wild"/> since that is your most damaging utility

  - <Skill name="Signet of the Wild"/> is taken on fights where no other utility is needed.
  ...
  - <Skill name="Dolyak Stance"/> is also useful in certain T4s to provide team stability. Notably, the last boss of [Chaos](/fractals/chaos-isles) and the champion before the boss of [Mai Trin](/fractals/captain-mai-trin-boss).

- Most healing skills on ranger are quite useful: <Skill name="We heal as one"/> is a large heal and extends the boons on yourself thanks to <Skill id="42944"/>. Secondly <Skill name="Bear stance"/> is a great condi cleanse either personally or for your team. It should always be brought for [Mai Trin](/fractals/captain-mai-trin-boss) and can be taken on Artsariiv or other fights with the  [Afflicted](https://wiki.guildwars2.com/wiki/Mistlock_Instability:_Afflicted) instability.
...
1.  If you can place traps before spawning the boss use <Skill name="Frost trap"/>.
2.  If a fire field isn’t present, equip an offhand torch and use <Skill id="12504"/>.
3.  <Skill name="Moa Stance"/> with <Trait name="Leader of the Pack"/>.
