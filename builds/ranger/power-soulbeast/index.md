...
| <Skill name="sharpeningstone" size="big" disableText/>    | Can be used before *Mistlock Singularity* precast for and swapped with a usual utility for some extra opener DPS.                             |
...
7.  <Skill name="One Wolf Pack"/> then take the *Mistlock Singularity* and trigger the boss.
