...
Note: This setup assumes you use stat infusions and standard utility. If you do not use stat infusions, <Item id="82791"/> is a damage increase.  Additionally, the optimal gear for power virtuoso will change depending on different combinations of <Item id="91805"/>, <Item id="43360"/>, <Item id="9443"/>, <Item id="50082"/> and <Item id="73191"/>! The resulting difference is negligibly small though. Two impact sigil gear sets are mainly provided because the eagle setup is straightforward to gear with berserker armor while the potion setup keeps deadeye runes like the optimal version without stat-infusions. Both setups use 4 precise infusions. Choose whatever is more convenient or explore more setups in the gear optimizer.
