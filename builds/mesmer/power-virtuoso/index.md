...
Note:  <Item id="24836"/> is a minor damage increase over <Item id="74978"/> when running slaying potions or writs while having <Augmentation name="Mist Attunement 4"/> and then in general the best setup when only one sigil swap is needed and no ferocity reflect shenanigans apply.
</Character>
