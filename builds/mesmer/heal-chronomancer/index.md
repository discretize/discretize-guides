...
Using your Raid setup is possible, but compared to the setup below, you gonna miss out on some additional <Attribute name="Healing Power"/> and a decent amount of <Attribute name="Vitality"/> & <Attribute name="Toughness"/>. 
...
We recommend this setup on encounters that require greater or more frequent defiant breaks e.g. Arstariiv and MAMA, as well as power composition, which require fast defiance breaks, in order to make use of <Item name="Impact" type="Sigil"/>.
