...
We recommend this setup on encounters that require greater or more frequent defiant breaks e.g. Arstariiv and MAMA, as well as power compositions, which require fast defiance breaks, in order to make use of <Item name="Impact" type="Sigil"/>.
