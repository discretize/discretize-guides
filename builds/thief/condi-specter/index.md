...
1. <Skill name="Enter Shadow Shroud"/> (F2)
2. <Skill name="Grasping Shadows"/> (Shroud 2)
3. <Skill name="Eternal Night"/> (Shroud 4)
4. <Skill name="Haunt Shot"/> (Shroud 1)
5. <Skill name="Grasping Shadows"/> (Shroud 2)
6. <Skill name="Exit Shadow Shroud"/> (F2)
