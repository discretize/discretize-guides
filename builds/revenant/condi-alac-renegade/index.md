...
This build is mainly to be used in Sunqua Peak and Silent Surf CMs. In other Fractals <BuildLink build="Power Renegade" specialization="Renegade"/> is strictly better due to a lot of factors such as quick burst, more support, and more versatility.

</Warning> 

Condi <Specialization name="Renegade"/> is an unique build that may only be played in Sunqua Peak and Silent Surf CMs, since it performs much better than <BuildLink build="Power Renegade" specialization="Renegade"/>, due to longer phases and the ability to attack from range. Condi <Specialization name="Renegade"/> has decent damage output and can be pretty efficient when played properly. Condi <Specialization name="Renegade"/> provides <Boon name="Alacrity"/> and some <Boon name="Might"/> through <Skill id="45537"/> and <Skill id="44076"/> respectively. Finally, to top it off this build has high CC capabilities with <Skill id="41220"/>, <Skill id="28409"/> and <Skill id="41820"/>.
...
If you have another <Specialization name="Renegade"/> in your party, you can both play Condi DPS Renegade and provide ~57% <Boon name="Alacrity"/> uptime each with <Trait name="lastinglegacy"/> and 15% Boon Duration.
...
- If you play double Renegade always use <Skill id="45537"/> during a <Skill id="41858"/> rotation
