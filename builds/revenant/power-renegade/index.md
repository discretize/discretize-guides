...
| <Skill name="Heroic Command" size="large" disableText/>                   | Cast Heroic Command, when you see your group missing might. Make sure that you have 5 Stacks of Kalla's Fervor for max might.                                                                                        |
| <Skill name="Legendary Renegade Stance"/>                                 |                                                                                                                                                                                                                      |
| <Skill name="Breakrazor's Bastion" size="large" disableText/>             | Good Group Heal and gives Resolution to your group.                                                                                                                                                                  |
...
| <Skill name="Enchanted Daggers" size="large" disableText/>                | Low heal skill that is mostly used as a precast at the Mistlock Singularity.                                                                                                                                         |
...
| <Skill name="Protective Solace" size="large" disableText/>                | Blocks projectiles and is a light combo field, allowing for easy condition cleanses. Uses can found on the final ship phase on Siren's reef as well as the final boss of Volcanic.                                   |
| <Skill name="Legendary Demon Stance"/>                                    |                                                                                                                                                                                                                      |
| <Skill name="Banish Enchantment" size="large" disableText/>               | Remove 3 boons from enemy target.                                                                                                                                                                                    |
...
| <Skill name="Inspiring Reinforcement" size="large" disableText/>          | Casually called 'Road', is often used to provide stability to the party and used often in the Chaos fractal.                                                                                                         |
...
| <Skill name="Facet of Chaos" size="large" disableText/>                   | Gives the party <Effect name="Superspeed"/>.                                                                                                                                                                         |
